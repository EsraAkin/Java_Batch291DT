...
sadece referanslar aracılığıyla erişilir. Harita yani map burda.
*/

        String s="Tom";  //Tom verisi Heap'te tutulur. Adresi ise Stack'te
        int a=12;        //Bu veri doğrudan Stack'te saklanır
 ...
 */
//******************** Önemli bilgi == adrese bakar, equals içeriğe bakar
String str1=new String("Merhaba");
String str2=new String("Merhaba");
String str3=str1; //str1'in adresini str3'ün adresi olarak yaptım
        System.out.println(str1==str2);// false adresleri kontrol eder
