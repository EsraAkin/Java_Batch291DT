...
public abstract class Honda {
   ...
   */
    ...
    public void music() {  //Bu metodu her child kullanmak zorunda değil.
        System.out.println("Pro");
    }

    public abstract void engine(); //Bu metodu her Child kullanmak zorunda. Kendine göre kullancak
    // Yani public class Honda { buraya abstact ekle
