...
public class Animal {
    ...
    */
    ...
    /*1.Inheritance, OOP'nin dort temel ozelliginin 1.sidir.//***Miras Alma
    ...
    extends -->uzanmak demek. Child parentı secer. Ben bu clasın özelliklerini kullanmak istiyorum der.
    ...
    //a) Java ‘Multiple Inheritance’ i desteklemez. ‘Single Inheritance’ i destekler.***yani childın 1 tane parentın olabilir.
    //b) Parent ve birden fazla child ile olusturulan inheritance yapilanmasina
    //  ‘Hierarchical Inheritance’ denir ve Java bunu kabul eder.//***Tek parent çok child olabilir. 1 parent 5 child mesela
    ...
    //-----------------------------
    //Return type void ise değişim olmaz. Hep void olarak kalır.
    ...
    public void eat() {  //final bir metod override edilemez
    ...
    //Ödev Final overload'a engel midir?

    public Animal create(){  //Bu metotun datatipi Animal. //**Javanın gözünde Animal String gibi bir data tipi
        return new Animal();  //***Animal objesi üretip dışarı Animal verdim.Yeni bir obje ürettim aslında
    }
