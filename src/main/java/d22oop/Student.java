 ...
 */
    ...
    private int age=13;  //Erişilemez olsun dedim
    private boolean successful=true; //Erişilemez olsun dedim

    //1- age ve successful datalarini okunabilir yapalim. Getter metodu okuma yaptigi icin parametre almaz
//*****get() metodu sadece okuma yaptığı için parametre almaz.
    ...
    public void setAge(int age) {
        this.age = age;   //Bu classtaki age'i kullanma, ben sana değer göndereceğim.
    }
