...
public class Variables01 {
    public static void main(String[] args) {
       ...
       //-------------------------------------------------------------------------------------------------------------------------------
        ...
        System.out.println("Toplam Price1: " + (sockPrice1 + shirtPrice1)); //Toplam Price1: 38.98
        //2.yol
        ...
        double cellWeight = 0.0000000000000000000028;
        System.out.println("cellWeight = " + cellWeight); //2.8E-21
        ...
        char firstLetterOfTheName = 'E';
        System.out.println("firstLetterOfTheName = " + firstLetterOfTheName); //firstLetterOfTheName = E
