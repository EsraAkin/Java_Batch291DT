...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        //******* Plus ve  minus için Yıl ay gün sırayla gir.
        ...
        System.out.println(myDate.getDayOfWeek()); //WEDNESDAY
        ...
        LocalDate date1 = LocalDate.of(1985, 5, 5);
        LocalDate date2 = LocalDate.of(2010, 5, 4);
        System.out.println("date1 =" + date1 + " ,date2= " + date2);   //date1 =1985-05-05 ,date2= 2010-05-04
