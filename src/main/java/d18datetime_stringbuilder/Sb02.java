...
public class Sb02 {
    public static void main(String[] args) {
        ...
        System.out.println(sb2.capacity());  //16 yani java Default olarak 16 Bytlık yer ayırdı.
        ...
        System.out.println(sb2.capacity()); // 34 --> 16*2+2=34 //Varsayılan 16 idi ben bunu aştım 2 katının 2 fazlası oldu capacity
        ...
        StringBuilder sb3=new StringBuilder(3);//Konstactor kısmına int yazılırsa capacity sayılır.
        // Kapacityi 3 olarak belirledim.
        System.out.println(sb3.append("Alis"));
        System.out.println(sb3.capacity()); //8 yani 2 katının 2 fazlası= 8
       ...
       sb4.append("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");  //20 x olunca 24e 34 tü. Ama ilk arttırımdan sonra caoacity =length yapıyor.
        System.out.println(sb4.length());   //24  //44
        System.out.println(sb4.capacity()); //34  //44
        //Aynı appende arttırınca geçerli bu
