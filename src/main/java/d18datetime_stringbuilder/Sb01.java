...
public class Sb01 {
    public static void main(String[] args) {
        ...
        */
        ...
        String s = "Java";
        String t = s + "x"; //Javax bu s den farklı yani başka bir data. Heapte t için yeni alan açılır.

        //****Kullanıcılar Ankara Ankara Ankara girince her seferinde tekrar takrar kayıt doğru değil.
        //pool havuz demek

        String str1 = "abc"; //havuza alınır
        String str2 = "abc"; //havuza alınır
        String str3 = new String("abc"); //yeni üretilir. Havuzda varsa bile yeni obje oluşturur.

        //str1 ve str2nin ref'leri aynıdır.
        //--------------------------------
