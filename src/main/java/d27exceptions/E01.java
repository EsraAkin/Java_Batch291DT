...
//division(5,0); // ArithmeticException //***if'lerle düzeltebilirim.
        division2(4, 0);
    ...
    public static void division2(int a, int b) {
        try {
            System.out.println(a / b); //***Hata beklediğin kodu buraya yaz.
            System.out.println("try içi görev tamamlandı");
        } catch (ArithmeticException e) {  //Aritmetiksel hataları yakalar.
        ...
        //*****Ben de exception fırlatabilirim yani
    ...
    public static void division3(int a, int b) {
        try {
            if (b == 0) {  //b Sıfırsa exception fırlat.
