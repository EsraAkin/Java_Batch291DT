...
public class Sb03 {
    public static void main(String[] args) {
        ...
        sb1.deleteCharAt(1);  //1. indextekini sil
        ...
        //5-insert(int offset, String str): Belirtilen konumdan itibaren verilen stringi ekler.  //araya ekler yani
        ...
        StringBuilder sb2 = new StringBuilder("Zava");  //Ascıı Z-->90
        StringBuilder sb3 = new StringBuilder("Kava");  //      K-->75


        int result = sb2.compareTo(sb3);  //15 Aralarında ne kadar fark var onu gösteriyor.
        // sb2 ve sb3 yerleri değişince  -15 veriyor.
        ...
        //Böylece toUpperCase gibi metotları kullanabilirim.
        ...
        StringBuilder newsb1=new StringBuilder(str);  //str Stringdi bunu tekrar StringBuilder yaptım.
        ...
        StringBuffer multi-thread oldugu icin ayni zamanda synchronized'dir
                ...
                2) Mutable String lazimsa , StringBuilder veya StringBuffer
                                ...
                                //******Tek iş yapılacaksa  Single Thread yani StringBuilder hızlı
                                //Banka mantığı ile düşün.
         */
        ...
        //***********String hem single thread hem de multi-thread  olarak görev yapar.
         }
}
