...
public class Varargs {
    public static void main(String[] args) {
        //Variable arguments-Değişken sayıda argümanlar

int result=add(3,5,7,8,4);
    ...
    public static int add(int...a){   //3 nokta koyunca Java bunu varargs kabul eder. Yani istediğin kadar değer gir.
        int sum=0;
        for (int w:a){
            sum=sum+w;
        }
