...
public class Maps01 {
    public static void main(String[] args) {
        ...
        System.out.println(myMap);    //{Ali Can=25, Ayşe Kaya=15, Veli Han=18, Fatma Yılmaz=25}//***Key uniq olmak zorundaydı.
        // Dolayısıyla üstüne yazdı.

        //Sadece ‘key’ degerlerini nasil alabiliriz?
        //keySet(): Map’teki tüm key’lerin bir set’ini döndürür.Set’in sırası rastgeledir.

        Set<String> keySide = myMap.keySet();  //Key tarafını Sete atarım.
        ...
        Collection<Integer> valueSide = myMap.values(); //**Values tarafını collectiona atmam lazım.
        System.out.println(valueSide); //[25, 15, 18, 19]

        //get(): Bir key’e karşılık gelen değeri döndürür.key verirsiniz value’sunu getirir

        Integer age = myMap.get("Ali Can");  //Ali Can verdim keyini yani 25'i döndürdü.
        ...
        int total = 0;
        Collection<Integer> ages = myMap.values();  //***Map'in value tarafını aldım.
        ...
        Set<Map.Entry<String, Integer>> myEntrySet = myMap.entrySet(); //*****Data tipi Map.Entry<String,Integer>
                                                                       // ***Bu kısım Key-Value durumuna göre değişir

        System.out.println(myEntrySet);  //[Ali Can=25, Ayşe Kaya=15, Veli Han=18, Fatma Yılmaz=19]  //*****Normalde bir Mapi
        //döngüye sokamam. Bunu yaptım ki artık Map'i döngüye sokabilirim.*** Yani bu artık Set yapısı, döngüye sokabilirim.
        //[] 'lerden anla.
