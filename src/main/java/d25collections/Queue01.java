...
Queue interface'i, LinkedList ve PriorityQueue gibi farklı class'lar tarafından uygulanabilir.*/
        ...
        Queue<String> storage = new LinkedList<>();  //***storage
        ...
        storage.add("yumurta");
        storage.add("peynir");
        //storage.add(null);  //Bunu da kabul eder
        System.out.println(storage); //[süt, et, yumurta, peynir] //*** insert sırasına göre

        //2) remove(): Kuyruğun başındaki öğeyi kuyruktan kaldırır ve döndürür.
        // Kuyruk boşsa bir istisna fırlatır.

        String s = storage.remove();
        System.out.println(s);  //süt //**en baştaki elemanı verdi. Sütü sildi ve bize sütü sildim diye haber verdi.
        ...
        //System.out.println(storage.clear()); //Böyle yazamam. Hem sil hem yazdır diyemem.
        storage.clear();
        System.out.println(storage); //[]

        //5)poll(): Kuyruğun başındaki öğeyi kuyruktan kaldırır ve döndürür. Kuyruk boşsa null döner.

        System.out.println(storage.poll());  //null //Çünkü artık storage boş.

        //6)element(): Kuyruğun başındaki öğeyi döndürür, ancak kuyruk boşsa bir istisna fırlatır.

        //System.out.println(storage.element());  //Exception fırlattı. Çünkü queue boş.
        ...
        System.out.println(emergencyQueue); //[Ekrem, Mehmet, Mahmut, Oya, Tansu]  //Karışık yazdırdı
        ...
        d.add("Oya");
        d.add("Tansu");
        System.out.println(d); //[Mehmet, Mahmut, Ekrem, Oya, Tansu] // LinkListten dolayı Ekleme sırası
        ...
        for (String w : d) {
            System.out.println(w); //Elemanları alt alta yazdırdım.
        }
        ...
        System.out.println(d.removeFirst()); //Ali //**Aliyi kaldırdım diyor.
        ...
        System.out.println(a);  //İlk //*** İlki kaldırdım diyor bana
        ...
        //Kuyruğa kaynak yapılır mı yani
