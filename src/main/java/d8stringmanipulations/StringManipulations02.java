...
*/
        ...
        //Ornek 2: “s” String’indeki rakam sayisini bulunuz.  //Javada birşeyi saymak için diğerlerini silerim.
        //Example 2: Find the number of digits in String “s”

       int num= s.replaceAll("[^0-9]", "").length();// Tüm rakamlar hariç hepsini sil dedim. ^ kullanarak yaptım  bunu.
