...
public class TypeCasting {
    public static void main(String[] args) {
        ...
        Bu isleme "AutoWidening" (Otomatik genisletme) denir. yani primitivler arası olur bu işlem. ör: int--->long   */
        ...
        int weight = 313;
        short weightShort = (short) weight;  //Tip dönüşümü yaptım. Java bunu otomatik yapmıyor. Benim kontrol ederek kendimin yapması gerek.
