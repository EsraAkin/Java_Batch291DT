...
public class Scanner03 {
    public static void main(String[] args) {
        ...
        // Scanner input = new Scanner(System.in).useLocale(Locale.US); ile ülke değiştirebilirim. nokta ya da virgül kullanımı için
        ...
        System.out.println("Subtraction1 : " + String.format("%.2f",(firstNumber-secondNumber))); //virgülden sonra 2 basamak gösterir.3 5
