...
public enum Cities {
    //*****enum da bir classtır ama özel bir clastır.
   ...
   enum'un temel avantajları şunlardır:
    ...
    private, bir değişkenin yalnızca class'in içinden erişilebilir olmasını sağlar. //***Mesela Ocak kimse değiştirememeli
    ...
    datanin icindeki variable'lari baslatmak icin ***yani ulaşmak için kullanilir
    */

    ADANA(1, "Adana", "01000"), //public static ve final ADANA yani
    ...
    //*****Sen 3 tane veriyi girdin ama bunu nereye girecen?
    ...
    //**************set() yok burda enum sabit değişmez.
