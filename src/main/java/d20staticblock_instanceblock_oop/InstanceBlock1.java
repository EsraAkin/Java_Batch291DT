...
public class InstanceBlock1 {
    ...
    //Instance block olusturalim //****//{ } yapınca instance blok oluşturur.//**Her class için ayrı oluşturmam gerek.
    {
    ...
    public static void main(String[] args) {
        ...
        InstanceBlock1 obj1 = new InstanceBlock1();  //çalıştı
        InstanceBlock1 obj2 = new InstanceBlock1();  //Her obje için tekrar çalışır.
