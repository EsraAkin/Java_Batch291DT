...
Thread safety ve performansın önemli olduğu her durumda tercih edilir.*/
        ...
        //studentGrades.put("Esra", null);  //HATA
        System.out.println(studentGrades);  //{Sefa=87, İbrahim=85, Selma=70, Tuba=75}
        ...
        stdAges.put(null, 41);
        System.out.println(stdAges); //{null=41, Ahmet=41, Ali=18}

        stdAges.put(null, 21);
        System.out.println(stdAges); //{null=21, Ahmet=41, Ali=18}

        stdAges.put("Esra", null);
        System.out.println(stdAges);  //{null=21, Ahmet=41, Esra=null, Ali=18}


        // ConcurrentHashMap oluşturma //***En moderni bu
        ...
        stock.putIfAbsent("Çilek", 30); //Çilek depomda yoksa ekle
        ...
        countryPopulation.put("German", 83000000);
        countryPopulation.put("USA", 400000000);
        countryPopulation.put("Türkiye", 83000000);
        countryPopulation.put("NetherLand", 180000000);
        //countryPopulation.put(null, 83000000 ); //HATA
        countryPopulation.put("France", null);
        countryPopulation.put("İtaly", null);


        System.out.println(countryPopulation);  //{France=null, German=83000000, NetherLand=180000000, Türkiye=83000000, USA=400000000, İtaly=null}
        ...
        */
        ...
        capitals.get("USA");
        System.out.println(capitals.get("USA"));   //Washington //***Key verince value getirdi

        //********Hash codu 16ya böler kalan sayısı neyse o indexe yerleştirir. Aynı kalan olursa link list ile sağa doğru ekler.
        //Yan yana 8 tane olumca Balanced Tree yapısına geçiş yapar.

        capitals.put("Türkiye", "İstanbul"); //Üstüne yazdı. Override yaptı yani.
        System.out.println(capitals.get("Türkiye"));  //İstanbul
