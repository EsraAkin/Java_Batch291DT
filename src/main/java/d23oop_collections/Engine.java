...
public interface Engine {
    ...
    */
    ...
    /*7) Normalde interface icine concrete method(bodyli metot) konulamaz ama bazi özel durumlarda concrete
...
object olusturarak ulasilabilir*/
   ...
   /* default void deneme() {  //Bunu override etme ihtiyacım varsa default kullan.

    }
   static void deneme() {  //Bunu override etme ihtiyacım yoksa static kullan.
    ...
    */
    ...
    int price = 2000; //public static final int price=2000;

    int fiyat = 300;

    default void power() {//Burda default access modifier değil. Keyword. Bu method @Override edilebilir.
